...
**STEPPS Audit:**
Score any piece of content (1-3 on each dimension):
...
**Content Brief:**
For each STEPPS element, provide specific recommendations for how to engineer that element into the content.
